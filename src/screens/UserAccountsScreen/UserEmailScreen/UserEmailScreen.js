...
export default class UserEmailScreen extends React.Component {
    constructor(props) {
        ...
        this.state = ({
            ...
            note: "Don't worry; we'll never sell your email for third party marketng purpose."
        })
    }
                ...
                <Content contentContainerStyle={styles.container}>
                    ...
                    <View style={styles.inputFormView} >
                        <Form>
                            ...
                            <Text style={{ alignSelf: 'center', textAlign: 'center', marginLeft: 50, marginRight: 50, marginTop: 5 }} note>{this.state.note}</Text>
                        </Form>
