        ...
        <Content contentContainerStyle={styles.container}>
          ...
          <View style={styles.inputFormView}>
            ...
            <Text
              ...
              note
            >
              {this.state.mobileNotes}
            </Text>

            <View style={styles.txtTermsOfUseView}>
              <Text note style={styles.txtTermsOfUse}>
                By signing up, you have read and accepted MyMoney{" "}
              </Text>
              <TouchableOpacity onPress={() => this.click_tearmsOfUse()}>
                <Text style={styles.txtTermsOfUse1}>Terms of Use</Text>
              </TouchableOpacity>
            </View>
          </View>
        </Content>
